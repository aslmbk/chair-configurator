...
export const Chair: React.FC = (props) => {
  ...
  return (
    <group {...props} dispose={null}>
      <mesh geometry={(nodes.Chair as THREE.Mesh).geometry} castShadow>
      ...
      <mesh
        geometry={(nodes.Cushion as THREE.Mesh).geometry}
      ...
      <mesh
        geometry={(nodes.Legs1 as THREE.Mesh).geometry}
        material={materials.Legs}
        visible={legs === 1}
        castShadow
      />
      <mesh
        geometry={(nodes.Legs2 as THREE.Mesh).geometry}
        material={materials.Legs}
        visible={legs === 2}
      />
    </group>
